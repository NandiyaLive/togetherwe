    ...
    <div className="projects">
      <div className="title">
        <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 46 44">
          ...
          <path d="M44.31 16c.933 0 1.7-.76 1.6-1.688A16 16 0 0 0 27.384.215c-.921.153-1.448 1.094-1.2 1.994.25.9 1.181 1.416 2.107 1.29a12.618 12.618 0 0 1 14.215 10.815c.125.926.87 1.686 1.804 1.686Z" fill="url(#a)" />
